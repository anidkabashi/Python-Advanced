...
selected_author = st.sidebar.selectbox("Select Author", ["All"] + list(nooks_df['Author'].unique()))
...
max_price = st.sidebar.slider("Maximum Price", 0, books_df['Price'].max(), book_df['Price'].max())
...
col2.metric("Uniqe Titles", unique_titles)
